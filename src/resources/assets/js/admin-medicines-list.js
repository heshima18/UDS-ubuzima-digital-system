...
(async function(){
    ...
    try {
        ...
        f = document.querySelector('form#add-medicine-form')
    ...
    f.addEventListener('submit', async e =>{
        ...
        if(v){
            ...
            for (const input of i) {
             ...
             b.textContent = `Recording medicine info...`
    
             a = await request('addmedicine',postschema);
            ...
            e = table.DataTable({
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        attr: { "data-bs-toggle": "modal", "data-bs-target": "#add-medicine" },
                    },
                ],
