...
(async function () {
    ...
    try {
        f = document.querySelector('form#add-department-form')
        ...
        f.addEventListener('submit', async e =>{
            ...
            if(v){
                ...
                for (const input of i) {
                    ...
                    b.textContent = `Recording department info...`
        
                    a = await request('add-department',postschema);
    ...
    $(document).ready(function () {
        ...
        m = m.message
        var table = $('.datatables-departments'),
            e = table.DataTable({
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        attr: { "data-bs-toggle": "modal", "data-bs-target": "#add-department" },
                    },
                ],
